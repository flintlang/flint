...
public class CoverageProvider {
    ...
    public func instrument(ast : TopLevelModule) -> TopLevelModule {
        ...
        do {
            ...
            try json_statement_dict.write(to: URL(fileURLWithPath: Path.getFullUrl(path: "utils/coverage/statements.json").absoluteString  /* %"/Users/Zubair/Documents/Imperial/Thesis/Code/flint/utils/coverage/statements.json" */), atomically: true, encoding: .utf8)
        } catch {
            print(error)
        ...
        do {
            ...
            try json_branch_dict.write(to: URL(fileURLWithPath: Path.getFullUrl(path: "utils/coverage/branch.json").absoluteString  /* %"/Users/Zubair/Documents/Imperial/Thesis/Code/flint/utils/coverage/branch.json" */), atomically: true, encoding: .utf8)
        } catch (let e) {
            print(e)
        ...
        do {
            ...
            try json_function_dict.write(to: URL(fileURLWithPath: Path.getFullUrl(path: "utils/coverage/function.json").absoluteString  /* %"/Users/Zubair/Documents/Imperial/Thesis/Code/flint/utils/coverage/function.json" */), atomically: true, encoding: .utf8)
        ...
        do {
            ...
            try json_function_to_line_no.write(to: URL(fileURLWithPath: Path.getFullUrl(path: "utils/coverage/function_to_line.json").absoluteString  /* %"/Users/Zubair/Documents/Imperial/Thesis/Code/flint/utils/coverage/function_to_line.json" */), atomically: true, encoding: .utf8)
        ...
        do {
              ...
              try json.write(to: URL(fileURLWithPath: Path.getFullUrl(path: "utils/coverage/counts.json").absoluteString  /* %"/Users/Zubair/Documents/Imperial/Thesis/Code/flint/utils/coverage/counts.json" */), atomically: true, encoding: .utf8)
        } catch (let e) {
            print(e)
