...
extension Diagnostic {
  ...
  static func returnFromInitializerWithoutInitializingAllProperties(_ initializerDeclaration: SpecialDeclaration, unassignedProperties: [VariableDeclaration]) -> Diagnostic {
